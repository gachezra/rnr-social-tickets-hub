...
export const events: Event[] = [
  {
    ...
    shortDescription:
      "Experience the excitement of F1 racing on the big screen with fellow enthusiasts!",
  ...
  },
  {
    ...
    shortDescription:
      "Watch the biggest match in European football with passionate fans in a vibrant atmosphere!",
  ...
  },
  {
    ...
    shortDescription:
      "Join fellow basketball fans to watch the NBA Finals in an electric atmosphere!",
  ...
  },
  {
    ...
    shortDescription:
      "Experience the intensity and drama of a Premier League derby with passionate fans!",
  ...
  },
  {
    ...
    shortDescription:
      "Experience the thrill of MotoGP racing with fellow motorsport fans!",
